...
const EDOGER_LEVEL_EXCEPTION			= 256;
const EDOGER_LEVEL_UNKNOWN				= 512;

//	Error levels.
const EDOGER_ERROR_NOTFOUND_CONTROLLER	= 101;
const EDOGER_ERROR_NOTFOUND_EXTEND		= 102;
const EDOGER_ERROR_NOTFOUND_VIEW		= 103;
const EDOGER_ERROR_NOTFOUND_MODEL		= 104;

const EDOGER_ERROR_RUNTIME				= 801;
const EDOGER_ERROR_ARGUMENT				= 802;
const EDOGER_ERROR_METHOD				= 803;
const EDOGER_ERROR_CONNECT				= 804;
